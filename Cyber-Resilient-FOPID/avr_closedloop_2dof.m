...
opts_1dof.local_refine = true;
opts_1dof.local_maxiter = 120;
opts_1dof.n_particles = 50;
opts_1dof.max_iter = 180;
...
% Multi-start only for the 1DoF comparison so we can push it closer to a
% competitive classical baseline without changing the main 2DoF search.
seed_bank_1dof = [
    0.80*Kp0, 0.80*Ki0, 0.50*Kd0, 0.95, 0.95;
    1.10*Kp0, 1.10*Ki0, 0.75*Kd0, 1.10, 1.10;
    1.40*Kp0, 1.40*Ki0, 1.00*Kd0, 1.20, 1.20];
